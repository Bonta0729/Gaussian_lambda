...
教師データでもっと深い探索をさせている場合は、評価値の信頼性が高まるのでlambdaをもう少しだけ上げても良いかもしれません。教師生成の為の計算資源が無いので、
深い探索の良質な教師データは持っていないので何とも言えないのですが、教師の探索depthが1上がる毎にlambdaを0.01ずつ上げていく位で良いような気がします。
