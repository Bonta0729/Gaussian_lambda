...
σ＝1000が正解の値なのかはわかりませんが、勝率連動型可変lambdaとして考えれば問題無いような気がします。もしかしたら全く違う値が正解の可能性も無いとは言えないですが、もう実験するのがきつくてモチベーションが続かないので、誰かが正解の値を見つけるまではこのままで行きます。  
...
実際はどうなのかは分かりません。(一応参考までに手元の実験結果ではlambda_limit=256でlambdaをかなり大きくして良い結果が出ています。)  
