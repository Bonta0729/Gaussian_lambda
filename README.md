...
指し手が固定化されて戦型が偏ってしまう懸念もあります。(実際に巷の評価関数は既に居飛車の特定の戦形に偏ってしまっているようですが、勝敗結果が原因なのかは分かりませんが、少なからず影響はあるような気がします。)  
...
勝率84.1％の評価値は約999.4になるのでわかりやすいように切り上げてσ＝1000に決定しました。
...
教師データでもっと深い探索をさせている場合は、評価値の信頼性が高まるのでlambdaをもう少しだけ上げても良いかもしれません。教師生成の為の計算資源が無く、
